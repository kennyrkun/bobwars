...
public:
	...
	// MODIFIES: This
	// EFFECTS:  If the given image is not already loaded, it is loaded into memory as a sf::Texture
	...
	// EFFECTS:  Returns a pointer to the loaded texture. Loads the image if it is not yet loaded
};
